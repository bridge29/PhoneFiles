...
class SuggestTVController: UITableViewController {
    ...
    let suggestItems = ["Take Photos of",
                        "drivers license",
                        "passport",
    ...
    override func viewDidLoad() {
        ...
        titleIdxs.append(suggestItems.indexOf("Take Photos of")!)
        titleIdxs.append(suggestItems.indexOf("Take Videos of")!)
        print(titleIdxs)
    }
